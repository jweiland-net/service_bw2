...
The Solr integration in the ServiceBW extension allows for the indexing and
searching of service portal contents. It covers indexer configurations and
logging configurations related to Solr.

The extension supports the integration of the following content into a Solr
search:

-   Organizations Units (Organisations Einheiten)
-   Life Situations (Lebens Lagen)
-   Services (leistungen)
...
1.  Root page where solr configured
...
6.  `service_bw2` constants
    ...
    just `service_bw2.solr` related constants
...
Here are the included solr indexing configurations included with the extension.
...
- ``tx_servicebw2_organisationsEinheiten``: Organizational units.
