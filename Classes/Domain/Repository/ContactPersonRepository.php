...
class ContactPersonRepository extends Repository
{
    ...
    {
        /** @var Request\ContactPersons\ContactPersonsList $request */
        $request = $this->objectManager->get(Request\ContactPersons\ContactPersonsList::class);
        $contactPersons = $this->serviceBwClient->processRequest($request);
