...
class KeywordRepository extends Repository
{
    ...
    {
        /** @var Request\Keywords\KeywordsByFirstLetterWithRefsInGebieten $request */
        $request = $this->objectManager->get(Request\Keywords\KeywordsByFirstLetterWithRefsInGebieten::class);
        $request->addParameter('firstLetter', 'a');
        $keywords = $this->serviceBwClient->processRequest($request);
