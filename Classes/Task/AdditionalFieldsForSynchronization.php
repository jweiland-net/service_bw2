 ...
 */
use JWeiland\ServiceBw2\Task\SynchronizeServiceBw;
...
class AdditionalFieldsForSynchronization implements AdditionalFieldProviderInterface
{
    ...
    /**
     * @var AbstractTask|SynchronizeServiceBw
     */
    protected $task;
    ...
    protected function createInputField($fieldName, array $configuration, array &$additionalFields)
    {
        ...
        $additionalFields[$attributes['id']] = array(
            ...
            'label'    => LocalizationUtility::translate('scheduler.' . $fieldName, 'ServiceBw2'),
