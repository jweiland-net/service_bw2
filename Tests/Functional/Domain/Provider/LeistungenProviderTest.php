 ...
 * Test case.
 */
class LeistungenProviderTest extends FunctionalTestCase
{
    protected LeistungenProvider $subject;
    ...
    protected function setUp(): void
    {
        ...
        $this->subject = new LeistungenProvider(
    ...
    public function findByIdWillRequestRecord()
    {
        ...
        $this->serviceBwClientMock
            ...
            ->with(
                self::isInstanceOf(Leistungsdetails::class),
                self::identicalTo('de'),
            )
            ->willReturn($data);
    ...
    public function findAllWillRequestRecords()
    {
        ...
        $this->serviceBwClientMock
            ...
            ->method('requestAll')
            ->with(
                self::isInstanceOf(Leistungen::class),
                self::identicalTo('de'),
            )
